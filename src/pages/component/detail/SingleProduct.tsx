        ...
        <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
              ...
              <Tab.List className="grid grid-cols-4 gap-6">
                {productDetails &&
                  productDetails.images.map((image: any) => (
                    <Tab
                      key={image.id}
                      className="relative flex h-36 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium uppercase text-gray-900 hover:bg-gray-50 "
                    >
                      {({ selected }) => (
                        <>
                          ...
                          <span
                            className={classNames(
                              selected ? "ring-green-600" : "ring-transparent",
            ...
            <Tab.Panels className="aspect-h-1 aspect-w-1 w-full">
              {productDetails &&
                productDetails.images.map((image: any, index: number) => (
                  <Tab.Panel key={index} className="h-[550px]">
                    <img
                      src={image.url}
                      className="h-full w-full  object-fill sm:rounded-lg"
                    />
                  </Tab.Panel>
                ))}
            </Tab.Panels>
          ...
          <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
            ...
            <form className="mt-6">
              {/* Colors */}
              <div>
                <ProductColorVariant color={productDetails?.color} />
              </div>
              <div>
                <ProductSizeVariant size={productDetails?.size} />
              </div>
